...
class TLDetector(object):
    def __init__(self):
        ...
        # Load TensorFlow and ensure it is ready
        ...
        print("Loading TensorFlow light classifier. Wait 10 seconds")
        t = threading.Timer(10.0, warm_up)
        t.daemon = True
        t.start()

        self.light_classifier = TLClassifier()
        print("Light classifier created")

        # Output of Fast RCNN NN
    ...
    def process_traffic_lights(self):
        ...
        if self.is_classifier_ready is True:
